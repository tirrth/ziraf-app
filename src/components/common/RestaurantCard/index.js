...
class RestaurantCard extends React.PureComponent {
	...
	render() {
		...
		return (
			<View style={[styles.container, data.isSuspended ? styles.opacityTranslucent : styles.opacityVisible]}>
				<AlertTransport
					data={data}
				...
				<TouchableOpacity
					onPress={this.handleNavigation.bind(this, data.id)}>
					<View style={{ flex: 1 }}>
						<View>
							<FastImage
							...
							{data.offers ? (
								<View style={styles.discountContainer}>
									...
									<TouchableOpacity 
										onPress={this.handleDiscount.bind(
											this,
											data.offers
										)}>
											<Image
											...
											<Text
												...
												fontVisby={true}>
												{!isNaN(data.offers.percentage) && (data.offers.percentage > 0 && data.offers.percentage < 101)
