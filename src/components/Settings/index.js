...
class Settings extends Component {
	...
	render() {
		const { userDetail, appConfig, navigation, setAppStateData, appState } = this.props;
		const { reviewModalVisible, onboardingModalVisible, inquiryModalVisible, qrModalVisible, pendingReviewListModalVisible } = this.state;
		let isSignedIn = false;
		if (userDetail) {
			isSignedIn = true;
		}
		...
		return (
			<SafeAreaView style={[styles.container]}>
					...
					<View style={[cs.padding20, { marginTop: 80 }]}>
						...
						<View
							...
							<View style={styles.settingsOptionContainer}>
								<TouchableOpacity
									onPress={() =>
										this.setInquiryModalVisible(true)
									}
									style={styles.settingsOption}>
									<Text
										style={styles.optionText}
				...
				<Modal
					...
					<View style={{ marginTop: 22, flex: 1 }}>
						<PendingReviewList
							...
							setModalVisible={this.setPendingReviewListModalVisible.bind(this)}
							navigation={navigation}
						/>
					</View>
				</Modal>
				...
				{this.isZirafUser(userDetail) && userDetail.zirafer && userDetail.zirafer.qrcode ? (
					<QRCode
