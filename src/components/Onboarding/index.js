      ...
      <View style={styles.container}>
              ...
              <View style={{flex: 1}}>
                <View>
                  ...
                  {this.state.currentPageState == 7 ? (
                    <View style={styles.rating_highlight}>
                      <Text
                        allowFontScaling={false}
                        style={{
                          color: '#fff',
        ...
        <View
          ...
          <Image
            ...
            source={require('../../images/icons/favourite_default.png')}
          />
          <Image
            style={styles.bottomNavBarIcon}
            source={require('../../images/icons/zirafers.png')}
          />
          <Image
            style={styles.bottomNavBarIcon}
            source={require('../../images/icons/home-active.png')}
          />
          <Image
            style={styles.bottomNavBarIcon}
        ...
        {this.state.currentPageState == 2 ? (
          <View
            ...
            <Text
              style={{backgroundColor: '#000', fontSize: 16, padding: 20}}
              fontSimplicity={true}>
              Create Your View by saving your food preference here
            </Text>
          </View>
        ) : null}
        ...
        {this.state.currentPageState == 3 ? (
          <View
            ...
            <Text
              style={{backgroundColor: '#000', fontSize: 16, padding: 20}}
              fontSimplicity={true}>
              Tap 'Ziraf' to see 'Your View', your personalized recommended
              options based on your food preferences
            </Text>
          </View>
        ) : null}
        ...
        {this.state.currentPageState == 7 ? (
          <View
            ...
            <Text
              style={{backgroundColor: '#000', fontSize: 16, padding: 20}}
              fontSimplicity={true}>
              Tap the rating to see the breakdown
            </Text>
          </View>
        ) : null}
        ...
        {this.state.currentPageState == 8 ? (
          <View
            ...
            <Text
              style={{backgroundColor: '#000', fontSize: 16, padding: 20}}
              fontSimplicity={true}>
              Tap here to get directions to the restaurant (only activated when
              "Create Your View")
            </Text>
          </View>
        ) : null}
          ...
          <TouchableOpacity
            ...
            <View>
              <View style={{top: 100}}>
                ...
                />
                <View
                  style={{width: '60%', alignSelf: 'center', paddingTop: 5}}>
                  <Text
                    style={[
                      cs.textWhite,
                      cs.textCenter,
                    ...
                    fontSimplicity={true}>
                    Hey there! I'm Ziraf and I am about to walk you through some
                    important tips
                  </Text>
                </View>
        ...
        {this.state.currentPageState > 1 ? (
          <TouchableOpacity
            style={styles.overlay_clear}
            onPress={this.goToNextPageSpecial.bind(this)}>
            <View>
              {/* slideshow area */}
              <View
                style={{
                  top: slideShowHeightArea,
                  alignSelf: 'center',
                  alignItems: 'center',
                }}>
