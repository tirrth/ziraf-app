...
class RestaurantDetail extends Component {
  ...
  componentDidUpdate(prevProps) {
    ...
    if (restaurantReview && restaurantReview !== prevProps.restaurantReview) {
  ...
  toggleFavourite = async () => {
    try {
      const {userDetail, restaurantDetail, setAppStateData} = this.props;
          ...
          <ScrollView>
            <View style={[]}>
              ...
              <TouchableOpacity
                ...
                onPress={() => {
                  this.setState({
                    ...
                    alertChildren: (
                      <RatingBreakdown
                        data={restaurantDetail.data.ratingBreakdown}
                      />
                    ),
                    alertOnClose: () => {
                      this.setState({
              ...
              <View style={styles.favouriteContainer}>
                <TouchableOpacity onPress={this.toggleFavourite.bind(this)}>
                  <Image
                    style={{
                      height: 20,
                      resizeMode: 'contain',
            ...
            <View>
              <View
                ...
                <TouchableOpacity
                  ...
                  style={[
                    currentTab === 'info' ? styles.activeTab : styles.tab,
                  ]}>
                  <Text
                    allowFontScaling={false}
                ...
                <TouchableOpacity
                  onPress={() => this.handleTabChange('reviews')}
                  style={[
                    currentTab === 'reviews' ? styles.activeTab : styles.tab,
                  ]}>
                  <Text
                    allowFontScaling={false}
                    style={[cs.font17, cs.textWhite, styles.tabText]}>
                ...
                <TouchableOpacity
                  ...
                  style={[
                    currentTab === 'menu' ? styles.activeTab : styles.tab,
                  ]}>
                  <Text
                    allowFontScaling={false}
                    style={[cs.font17, cs.textWhite, styles.tabText]}>
                ...
                {currentTab === 'info' ? (
                  <View>
                    ...
                    <View style={{marginTop: 30}}>
                      {restaurantDetail.data.topDishes.length > 0 && (
                        <React.Fragment>
                          <Text
                            allowFontScaling={false}
                            style={[
                          ...
                          restaurantDetail.data.topDishes.length ? (
                            <View
                              style={[
                                cs.marginTB15,
                                {
                                          ...
                                          <View>
                                            ...
                                            <Text
                                              ...
                                              {restaurantDetail.data &&
                                                restaurantDetail.data
                                                  .priceRange &&
                                                restaurantDetail.data.priceRange
                                                  .symbol}
                                              {topDish.price}
                                            </Text>
                                          </View>
                      ...
                      <View
                        ...
                        <Text
                          allowFontScaling={false}
                          style={[cs.textBold, cs.font13, {width: '60%'}]}
                          selectable>
                          {restaurantDetail.data.address}
                        </Text>
                        <Text
                          ...
                          Price: {restaurantDetail.data.priceRange.symbol}
                          {restaurantDetail.data.priceRange.min} -{' '}
                          {restaurantDetail.data.priceRange.symbol}
                          {restaurantDetail.data.priceRange.max}
                        </Text>
                      </View>
                    </View>

                    <View style={[cs.paddingTB30, styles.moreInfoContainer]}>
                      {/* <View
											style={{
												borderRightWidth: 1,
												borderColor: '#fff',
                      ...
                      <View
                        ...
                        restaurantDetail.data.offers.description ? (
                          <TouchableOpacity
                            onPress={() => {
                              this.setState({
                                alertSize: false,
                                ...
                                alertChildren: (
                                  <DiscountModal
                                    data={restaurantDetail.data.offers}
                                  />
                                ),
                                alertOnClose: () => {
                                  this.setState({
                        ...
                        {restaurantDetail.data &&
                        restaurantDetail.data.operatingHours ? (
                          <TouchableOpacity
                            onPress={() => {
                              this.setState({
                                alertSize: false,
                                ...
                                alertChildren: (
                                  <OperatingHours
                                    data={restaurantDetail.data.operatingHours}
                                  />
                                ),
                                alertOnClose: () => {
                                  this.setState({
                        ...
                        {restaurantDetail.data &&
                        restaurantDetail.data.delivery ? (
                          <TouchableOpacity
                        ...
                        {restaurantDetail.data &&
                        restaurantDetail.data.reservation ? (
                          <TouchableOpacity
                            onPress={this.handleRestaurantAnalytics.bind(
                              this,
                              restaurantDetail.data.title,
                        ...
                        {restaurantDetail.data &&
                        restaurantDetail.data.transport ? (
                          <TouchableOpacity
                            onPress={() =>
                              this.setState({
                                alertTransport: true,
                ...
                {currentTab === 'reviews' ? (
                  <View>
                    ...
                    <RestaurantReview
                      ...
                      openSortModal={this.openSortModal.bind(this)}
                      reviews={reviews}
              ...
              <View style={[cs.padding20, styles.modalContainer]}>
                <View style={styles.sortRow}>
                  <View style={styles.sortField}>
                    <Text
                      style={[
                        ...
                        cs.textBold,
                        cs.textWhite,
                        sorting.name ? cs.textOrange : cs.textWhite,
                      ]}>
                      Names
                    </Text>
                  </View>
                  <View style={styles.sortFieldOptions}>
                    <TouchableOpacity
                      onPress={() => this.changeSort('name', 'ascending')}>
                      <Text
                        style={[
                          styles.sortOption,
                          cs.font12,
                          cs.textWhite,
                          sorting.name && sorting.name === 'ascending'
                            ? cs.textOrange
                            : cs.textWhite,
                        ]}>
                        A to Z
                    ...
                    <TouchableOpacity
                      onPress={() => this.changeSort('name', 'descending')}>
                      <Text
                        style={[
                          styles.sortOption,
                          cs.font12,
                          cs.textWhite,
                          sorting.name && sorting.name === 'descending'
                            ? cs.textOrange
                            : cs.textWhite,
                        ]}>
                        Z to A
                ...
                <View style={styles.sortRow}>
                  <View style={styles.sortField}>
                    <Text
                      style={[
                        ...
                        cs.textBold,
                        cs.textWhite,
                        sorting.updates ? cs.textOrange : cs.textWhite,
                      ]}>
                      Updates
                    </Text>
                  </View>
                  <View style={styles.sortFieldOptions}>
                    <TouchableOpacity
                      onPress={() => this.changeSort('updates', 'latest')}>
                      <Text
                        style={[
                          styles.sortOption,
                          cs.font12,
                          cs.textWhite,
                          sorting.updates && sorting.updates === 'latest'
                            ? cs.textOrange
                            : cs.textWhite,
                        ]}>
                        Latest
                    ...
                    <Text style={[cs.textWhite, styles.textSeparator]}>|</Text>
                    <TouchableOpacity
                      onPress={() => this.changeSort('updates', 'oldest')}>
                      <Text
                        style={[
                          styles.sortOption,
                          cs.font12,
                          cs.textWhite,
                          sorting.updates && sorting.updates === 'oldest'
                            ? cs.textOrange
                            : cs.textWhite,
                        ]}>
                        Oldest
