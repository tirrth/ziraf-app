...
import {fetchUserDetail, clearAppState} from '../../js/actions/actionCreators';
...
class EditProfile extends Component {
  ...
  componentDidMount() {
    ...
    if (userDetail) {
      ...
      if (userDetail.zirafer) {
        ...
        form['facebook'] =
          userDetail.zirafer.social && userDetail.zirafer.social.facebook;
        form['instagram'] =
          userDetail.zirafer.social && userDetail.zirafer.social.instagram;
        form['youtube'] =
          userDetail.zirafer.social && userDetail.zirafer.social.youtube;
        form['website'] =
          userDetail.zirafer.social && userDetail.zirafer.social.website;
        ...
        zirafer['specialitySelected'] = userDetail.zirafer.specialities.map(
          speciality => speciality._id,
        );

        zirafer[
          'specialitySelectedLabel'
        ] = userDetail.zirafer.specialities.map(speciality => speciality.title);
  ...
  handleSubmit() {
    ...
    if (isZirafer) {
      ...
      if (form.website) {
        if (
          !form.website.includes('http://') ||
          !form.website.includes('https://')
        ) {
          ...
          fetchUserDetailData()
            .then(res => {
              ...
              this.setState({
                ...
                alertSuccess: true,
                alertTitle: `Success`,
                alertDetail: 'Your profile has been successfully updated',
                alertOnClose: () => {
                  this.setState(
                    {
                      alertSuccess: false,
              ...
              <View>
                <View style={{}}>
                  ...
                  <View style={{padding: 15}}>
                    <View
                      style={[styles.fieldContainer, {flexDirection: 'row'}]}>
                      <View style={{width: '50%'}}>
                        ...
                        <TextInput
                          ...
                          placeholder="First"
                          onChangeText={text =>
                            this.handleValueChange('firstName', text)
                          }
                          onSubmitEditing={() => {
                      ...
                      <View style={{width: '50%'}}>
                        ...
                        <TextInput
                          ...
                          placeholder="Last"
                          onChangeText={text =>
                            this.handleValueChange('lastName', text)
                          }
                          onSubmitEditing={() => {
                    ...
                    <View style={[styles.fieldContainer]}>
                      ...
                      {isValidUserName ? (
                        <View style={styles.verifiedContainer}>
                          ...
                          />
                          <Text style={[cs.textWhite]}>Verified</Text>
                        </View>
                      ) : null}
                      {errors.username ? (
                        <Text style={[styles.errorText]}>
                    ...
                    <View
                      ...
                      <View style={{width: '30%'}}>
                        ...
                        <TouchableOpacity
                          ...
                          {form.gender ? (
                            <Text
                              ...
                              style={[cs.textBold, cs.textWhite]}>
                        ...
                        <Modal
                          animationType="none"
                          transparent={true}
                          visible={!showGenderOptions ? false : true}
                          onRequestClose={() => {}}>
                          <TouchableOpacity
                            style={{flex: 1}}
                            onPress={() =>
                              ...
                              <ScrollView>
                                {GENDER_OPTIONS.map((option, idx) => (
                                  <TouchableOpacity
                                    ...
                                    <Text
                                      style={[cs.textCenter, cs.textOrange]}>
                                      {option.name}
                                    </Text>
                                  </TouchableOpacity>
                                ))}
                      ...
                      <View style={{width: '70%'}}>
                        ...
                        <TextInput
                          ...
                          onChangeText={text =>
                            this.handleValueChange('phone', text)
                          }
                          onSubmitEditing={() => {
                            this.bioInput.focus();
                          }}
                      ...
                      <React.Fragment>
                        <View style={[styles.fieldContainer]}>
                          ...
                          <TextInput
                            ...
                            placeholder="Bio"
                            onChangeText={text =>
                              this.handleValueChange('description', text)
                            }
                            onSubmitEditing={() => {
                        ...
                        <TouchableOpacity
                          style={styles.fieldContainer}
                          onPress={this.openModalOption.bind(this, {
                            modalOptionsTitle: 'Favourite Restaurant',
                            modalOptionsData: restaurantList.data,
                            modalOptionsSelected: [restaurantSelected],
                            modalOptionLabelField: 'title',
                            modalOptionValueField: 'id',
                            modalOptionValues: 'restaurantSelected',
                            modalOptionStateLabels: 'restaurantSelectedLabel',
                            modalOptionMultiple: false,
                          })}>
                          <Text style={[styles.inputLabel]}>
                        ...
                        <TouchableOpacity
                          style={styles.fieldContainer}
                          onPress={this.openModalOption.bind(this, {
                            modalOptionsTitle: 'Speciality',
                            modalOptionsData: appConfig.data.filters.cuisines,
                            modalOptionsSelected: specialitySelected,
                            modalOptionLabelField: 'name',
                            modalOptionValueField: 'id',
                            modalOptionValues: 'specialitySelected',
                            modalOptionStateLabels: 'specialitySelectedLabel',
                          ...
                          <View
                            ...
                            {specialitySelectedLabel.map(special => (
                              <Text
                                style={[
                                  {
                                    color: '#FFFFFF',
                        ...
                        <View style={[styles.fieldContainer]}>
                          ...
                          <TextInput
                            ...
                            onChangeText={text =>
                              this.handleValueChange('facebook', text)
                            }
                            onSubmitEditing={() => {
                        ...
                        <View style={[styles.fieldContainer]}>
                          ...
                          <TextInput
                            ...
                            onChangeText={text =>
                              this.handleValueChange('instagram', text)
                            }
                            onSubmitEditing={() => {
                        ...
                        <View style={[styles.fieldContainer]}>
                          ...
                          <TextInput
                            ...
                            onChangeText={text =>
                              this.handleValueChange('youtube', text)
                            }
                            onSubmitEditing={() => {
                        ...
                        <View style={[styles.fieldContainer]}>
                          ...
                          <TextInput
                            ...
                            onChangeText={text =>
                              this.handleValueChange('website', text)
                            }
                            value={form.website}
                          />
                          {errors.website ? (
                    ...
                    <View
                      ...
                      {!isSubmitting ? (
                        ...
                        <View
                          style={[styles.loginButton, {borderColor: '#EEE'}]}>
                          <Text
                            style={[
                              cs.textCenter,
                              cs.font18,
