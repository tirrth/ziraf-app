...
class Zirafers extends Component {
  ...
  componentDidMount() {
    const {ziraferList, fetchZiraferList, navigation, route} = this.props;
    if (!ziraferList) {
      fetchZiraferList({});
    }
      ...
      <View style={[styles.container]}>
        ...
        <View
          ...
          <View
            ...
            <TouchableOpacity onPress={() => this.handleTabChange('profiles')}>
              <Text
                style={[
                  cs.font14,
                  cs.textWhite,
            ...
            <TouchableOpacity
              ...
              style={[
                currentTab === 'favourites' ? styles.activeTab : styles.tab,
              ]}>
              <Text
                style={[
                  cs.font14,
...
export default connect(mapStateToProps, {fetchZiraferList: fetchZirafers})(
  Zirafers,
);
