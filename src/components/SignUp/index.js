...
class SignUp extends Component {
  ...
  handleSubmit() {
    ...
    if (form.password != form.confirmPassword) {
      ...
      errors['confirmPassword'] =
        'Please make sure you reenter your password correctly';
    }
  ...
  handleAlertClose() {
    this.setState({alertSuccess: false}, () => {
      ...
      navigation.reset({routes: [{name: 'HomeRoot'}]});
    });
  }
        ...
        <ScrollView>
          <View style={{padding: 15, marginTop: 60}}>
            ...
            <View
              ...
              />
              <Text style={[cs.textBold, {color: '#737373', fontSize: 10}]}>
            ...
            <View style={{}}>
              ...
              <View style={[styles.fieldContainer]}>
                ...
                {isValidUserName ? (
                  <View style={styles.verifiedContainer}>
                    ...
                    />
                    <Text style={[cs.textOrange]}>Verified</Text>
                  </View>
                ) : null}
                {errors.userName ? (
                  <Text style={[styles.errorText]}>
              ...
              <View
                ...
                {!isSubmitting ? (
                  ...
                  <View style={[styles.loginButton, {borderColor: '#333'}]}>
                    <Text
                      style={[
                        cs.textCenter,
                        cs.font18,
